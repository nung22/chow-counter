...
export default function FoodForm(props) {
  ...
  return (
  <form className="flex flex-col gap-5 mt-4 bg-gray-800 border-gray-600 border-2 rounded-xl p-6" onSubmit={onSubmitHandler}>
    <div className="form-control w-full max-w-xs">
      <label className="label">
        <span className="label-text">Name</span>
      </label>
      <input type="text" placeholder="Type here" className="input input-bordered bg-gray-800" style={{width:'25rem'}} 
    ...
    <div className="grid grid-cols-3 gap-2">
      <div className="form-control w-full max-w-xs">
        ...
        <input type="text" placeholder="" className="input input-bordered bg-gray-800 w-32 max-w-xs" 
